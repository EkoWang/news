var tipAssetId1="MANU0000000000056771";//电影公告assetId
var tipAssetId2="MANU0000000000056275";//电视剧公告assetId
...
var returnIp = "http://vod.fjgdwl.com:80/movie20141020/";//从vod返回到本应用的路径
var searchUrl="http://vod.fjgdwl.com:80/SearchNew/search_2.htm";//搜索页面路径

var topAssetIdSerie = "MANU0000000000051772";//电视剧推荐栏目的assetId
var menuAssetIdsSerie = ["MANU0000000000051144","MANU0000000000051139","MANU0000000000051141","MANU0000000000051142"]; //电视剧 最新上线、热门剧集、港台专区、海外专区四个分类的assetId
var topAssetIdMovie = "MANU0000000000051771";//电影推荐栏目的assetId
var menuAssetIdsMovie = ["MANU0000000000051134","MANU0000000000051135","MANU0000000000051136","MANU0000000000051137"]; //电影 最新大片、热播影院、华语专区、海外专区四个分类的assetId
var searchMenuAssetId = "MANU0000000000050996"; //搜索的大栏目id

var area_code = VOD.areaCode;
	if(code == ""){
		code = VOD.server.regionId;
	}
	if(code == ""){
		code = VOD.server.nodeGroupID;
	};
...
function ajaxClass(_url, _successCallback, _failureCallback, _urlParameters, _callbackParams, _async, _charset, _timeout, _frequency, _requestTimes, _frame) {
	...
	this.timeout = _timeout || 10000; //20s
